function [insAtt_new,insVel_new,insLLH_new,x_err_new,P_new,postFit]= odomUpt(insVel_old,insAtt_old,insLLH_old,x_err_old,P_old,psiEst_minus,psiEst,dt_odom,rearVel,headRate,s_or,H11,H12,H21,H31,H32,H41,H42,z11,z21,z31,z41,T_r,sigma_or_L,sigma_or_R,sigma_cmc,s_delta_or)
...
H21=H21*(insAtt_old(3)-psiEst_minus)/dt_odom^2;
H31=-H31/dt_odom;
H32=-H32/dt_odom;
...
z1_ins=z11; %Checked
z2_ins=((insAtt_old(3)-psiEst))*z21;
% fprintf("psiEst: %.6f\n", psiEst);
if abs(z2_ins) > 0.5
    disp('Heading spike! errorCorrected')
    fprintf("psiEst: %.6f\n", psiEst);
    fprintf("insAtt_old(3): %.6f\n", insAtt_old(3));
    fprintf("z21: %.6f\n", z21);
    fprintf("z2_ins: %.6f\n", z2_ins);
    z2_ins=0;
end
